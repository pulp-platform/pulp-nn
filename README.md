...
To maximize the data reusing and speed-up the computation, Deptwise kernel performs an im2col step, in which not only kxk input activations are loaded and reordered but H rows.
...
+ Depthwise: each core computes a balanced number of channel of the Output Feature Map;
