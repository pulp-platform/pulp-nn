...
%if config.out_data_t != 8:
    ...
    int sum8 = 0;//bias4;
%else:
  %if config.quantization != 'thresholds':
    int sum =  0;//bias1;// + nn_round(out_shift);
    int sum2 = 0;//bias2;// + nn_round(out_shift);
    int sum3 = 0;//bias3;// + nn_round(out_shift);
    int sum4 = 0;//bias4;// + nn_round(out_shift);

    int sum5 = 0;//bias1;// + nn_round(out_shift);
    int sum6 = 0;//bias2;// + nn_round(out_shift);
    int sum7 = 0;//bias3;// + nn_round(out_shift);
    int sum8 = 0;//bias4;// + nn_round(out_shift);
  %endif
%endif
...
%if config.out_data_t == 8 or config.quantization == 'shift_clip':
