...
void __attribute__ ((noinline)) Conv3x3_Vectorized  (uint8_t * In_Img, uint8_t * Out_Img, int R, int C, int CH, int p_l, int p_r, int8_t  * Kernel,
  int8_t out_shift, uint16_t out_mult, int32_t * kappa, int32_t * lambda, int flag_relu, int flag_batch_norm)
{ 
